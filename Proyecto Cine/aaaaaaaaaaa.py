    ...
    def etiquetas_hora_funciones(frame, titulo, tex1, tex2, tex3):
        ...
        def bot(frame, frame_funciones):
            for h in range(3):
                ...
                boton = Button(frame, text=f"Sala {h+1}", command=lambda f=frame_funcion: [mostrar_frame(frame_principal[0]), crear_matriz(frame_principal[0], h)], bg="black", fg="white", font=("Times New Roman", 25), state=estado)
                boton.place(x=300, y=50 + 200 * h, width=200, height=100)
         
        # Crear elementos de la interfaz
        etiqueta = Label(nueva_ventana, text=titulo, bg="black", fg="white", font=("Times New Roman", 25))
        etiqueta.place(x=910, y=560)

        e_sala1 = Label(nueva_ventana, text=tex1, bg="black", fg="white", font=("Times New Roman", 25))
        e_sala1.place(x=30, y=90)

        e_sala2 = Label(nueva_ventana, text=tex2, bg="black", fg="white", font=("Times New Roman", 25))
        e_sala2.place(x=30, y=280)

        e_sala3 = Label(nueva_ventana, text=tex3, bg="black", fg="white", font=("Times New Roman", 25))
        e_sala3.place(x=30, y=480)

        e_entradas = Label(nueva_ventana, text="2D General ", bg="black", fg="white", font=("Times New Roman", 25))
        e_entradas.place(x=30, y=600)

        label_contador = Label(nueva_ventana, text="0", bg="black", fg="white", font=("Times New Roman", 18))
        ...
        label_confirmacion = Label(nueva_ventana, text="Entradas: Ninguna",font=("Times New Roman", 20), fg="white", bg="black")
...
# Frame principal
frame_principal = crear_frames(root, 3, "principal")
...
button_load_data = tk.Button(root, text="Cargar Datos", command=load_data)
